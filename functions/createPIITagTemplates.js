...
async function main() {
	const infoTypesArr = ['ADVERTISING_ID', 'AGE', 'CREDIT_CARD_NUMBER', 'DATE', 'DATE_OF_BIRTH', 'DOMAIN_NAME', 'EMAIL_ADDRESS', 'ETHNIC_GROUP', 'FIRST_NAME', 'LAST_NAME', 'PERSON_NAME', 'GENDER', 'GENERIC_ID', 'IMEI_HARDWARE_ID', 'IP_ADDRESS', 'LOCATION', 'MAC_ADDRESS', 'MAC_ADDRESS_LOCAL', 'ORGANIZATION_NAME', 'STREET_ADDRESS', 'SWIFT_CODE', 'URL', 'VEHICLE_IDENTIFICATION_NUMBER', 'UK_DRIVERS_LICENSE_NUMBER', 'UK_NATIONAL_INSURANCE_NUMBER', 'UK_TAXPAYER_NUMBER'];
